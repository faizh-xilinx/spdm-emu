                                        ...
                                        uint8_t key_sub_stream, char *key_sub_stream_str)
{
    ...
    LIBSPDM_DEBUG((LIBSPDM_DEBUG_INFO, "key_set_go %s - %02x, time taken: %lld us\n",
                  key_sub_stream_str, kp_ack_status, elapsed_time));
                              ...
                              uint8_t key_sub_stream, char *key_sub_stream_str)
{
    ...
    LIBSPDM_DEBUG((LIBSPDM_DEBUG_INFO, "key_set_stop %s, time taken: %lld us\n",
                  key_sub_stream_str, elapsed_time));
...
libspdm_return_t pci_tdisp_process_session_message(void *spdm_context, uint32_t session_id)
{
    ...
    interface_id.function_id = vf_function_id;
